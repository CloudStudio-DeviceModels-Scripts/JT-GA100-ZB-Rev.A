...
# Configuration Script – JT-GA100-ZB - Rev. A

This **Configuration** script is designed for the **JT-GA100-ZB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – JT-GA100-ZB Rev. A

Este script de **Configuration** está diseñado para el modelo **JT-GA100-ZB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
